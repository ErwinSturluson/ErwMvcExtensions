...
namespace ErwMvcExtensions.ValidationAttributes
{
    ...
    public class RequiredIfAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public RequiredIfAttribute(string propertyToCheck, object propertyToCheckValue, CompareMethod compareMethod)
        {
        ...
        public override string FormatErrorMessage(string name)
        {
            ...
            try
            {
                if (this.ErrorMessageResourceType == null)
                {
                    ...
                    formattingPattern = resourceManager.GetString("RequiredIf", CultureInfoExtensions.GetCultureFromHttp(HttpContext.Current.Request));
                }
            ...
            {
                formattingPattern = "Field {0} is required if field {1} {2} {3}.";
            }
        ...
        private bool IsRequired(object actualPropertyToCheckValue)
        {
        ...
        public IEnumerable<ModelClientValidationRule> GetClientValidationRules(ModelMetadata metadata, ControllerContext context)
        {
            ...
            yield return new ModelClientValidationRequiredIfRule(this.FormatErrorMessage(propertiesDisplayNamesString), this.propertyToCheck, this.propertyToCheckValue, this.compareMethod);
        }
    }

    public class ModelClientValidationRequiredIfRule : ModelClientValidationRule
    {
        public ModelClientValidationRequiredIfRule(string errorMessage, string propertyToCheck, object propertyToCheckValue, CompareMethod compareMethod)
        {
            this.ValidationType = "requiredif";
